...
# Folder name to be used when autolocating search directori
set -q __require_dir_name; or set -gx __require_dir_name include

# File extension for libraries
set -q __require_lib_ext; or set -gx __require_lib_ext fish
